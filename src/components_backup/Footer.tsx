  ...
  return (
    <footer id="contact-section" className="pt-16 pb-8 relative overflow-hidden z-10">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="space-y-3.5 font-mono text-xs">
              ...
              <div className="flex items-center gap-3 text-brand-text-muted">
                ...
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="hover:text-brand-accent transition-colors cursor-pointer">
            ...
            <div className="bg-brand-card border border-brand-border rounded-2xl p-5 md:p-6 shadow-sm relative overflow-hidden">
              ...
              {submitSuccess ? (
                <div className="py-8 text-center space-y-4">
                  ...
                  <div>
                    <h4 className="font-display text-sm font-bold text-brand-text-main uppercase tracking-wider">MESSAGE STREAM ROUTED SUCCESSFULY</h4>
        ...
        {/* Outer footer credit */}
        <div className="flex flex-col sm:flex-row justify-between items-center pt-8 text-[11px] text-brand-text-muted font-mono gap-4">
